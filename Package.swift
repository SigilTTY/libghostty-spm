...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/SigilTTY/libghostty-spm/releases/download/storage.1.3.9/GhosttyKit.xcframework.zip",
            checksum: "be0713c5276c68b1bb19ca624af31b350ba56fa39e5b405dd49855f5f489ee5e"
        ),
        .testTarget(
            name: "GhosttyKitTest",
